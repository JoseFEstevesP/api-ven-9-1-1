...
const registerDTOSchema = Type.Object(
  {
    ...
    article: permissionsDTOSchemas,
    articleUid: idDTOSchemas,
    department: permissionsDTOSchemas,
...
const assignRegisterDTO = (req, res, next) => {
...
export default assignRegisterDTO;
