...
// Controlador para la lectura de muebles
const furnitureReadController = async (req, res) => {
  try {
    ...
    // Realizar la consulta a la base de datos para obtener los muebles
...
export default furnitureReadController;
